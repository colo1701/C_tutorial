...
int main() {
    ...
    /*
    If %d is called in the print argument, it will handle a as an integer and return -1,999,998,663.
    ...
    In this case the unsigned int value of a will restart counting down from 4,294,967,295 once it
